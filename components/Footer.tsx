        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white">Vida View</span>
            </div>
            <p className="text-purple-200 text-sm">
              Apartemen modern dengan pemandangan terbaik di kota
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-purple-200 hover:text-white transition-colors">Tentang Kami</a></li>
              <li><a href="#" className="text-purple-200 hover:text-white transition-colors">Unit Tersedia</a></li>
              <li><a href="#" className="text-purple-200 hover:text-white transition-colors">Fasilitas</a></li>
